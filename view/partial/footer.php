...
<div class="haut-footer">
            ...
            <div>
                ...
                <a class="lienRS" href="#"><i class='bx bxl-tiktok'></i></a>
            </div>
            <div>
                ...
                <div class="mobile-firstNewsletter">
                    <form action="#">
                        ...
                        <textarea name="" class="barreMess" placeholder="Votre message" type="text"></textarea>
                        <input class="buttonNewsletter" value="ENVOYER" type="submit">
                    </form>
        ...
        <footer>
            <div class="sous-footer">
                ...
                <p class="copyR">Copyright 2024 © MielQualityS | Réalisé par Monsieur.SAID.S</p>
            </div>
        </footer>